...
class Weekly {
  List<WeeklySubjects> subjects;
  String title;

  Weekly.fromParams({this.subjects, this.title});

  factory Weekly(jsonStr) => jsonStr == null ? null : jsonStr is String ? Weekly.fromJson(json.decode(jsonStr)) : Weekly.fromJson(jsonStr);

  Weekly.fromJson(json) {
    if (json['subjects'] != null) {
      subjects = new List<WeeklySubjects>();
      json['subjects'].forEach((v) {
        subjects.add(new WeeklySubjects.fromJson(v));
      });
    }
    title = json['title'];
  }
...
class WeeklySubjects {
  Subject subject;
  int rank;
  int delta;

  WeeklySubjects({this.subject, this.rank, this.delta});

  WeeklySubjects.fromJson(Map<String, dynamic> json) {
    subject =
