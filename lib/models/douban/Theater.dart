...
class Threater {
  ...
  Threater.fromParams({this.count, this.start, this.total, this.subjects, this.title});

  factory Threater(jsonStr) => jsonStr == null ? null : jsonStr is String ? Threater.fromJson(json.decode(jsonStr)) : Threater.fromJson(jsonStr);

  Threater.fromJson(json) {
    count = json['count'];
    start = json['start'];
    total = json['total'];
...
class Details {
  ...
  Details.fromJson(Map<String, dynamic> json) {
    i1 = json['1'] != 0 ? json['1'] : 0.0;
    i2 = json['2'] != 0 ? json['2'] : 0.0;
    i3 = json['3'] != 0 ? json['3'] : 0.0;
    i4 = json['4'] != 0 ? json['4'] : 0.0;
    i5 = json['5'] != 0 ? json['5'] : 0.0;
  }
